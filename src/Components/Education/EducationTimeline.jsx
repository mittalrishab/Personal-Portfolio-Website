...
const TimelineEntry = ({
  ...
  <div className={`flex flex-col md:flex-row items-center w-full mb-14 ${side === 'left' ? 'md:flex-row-reverse' : ''}`}>
    ...
    <div className="z-20 flex items-center justify-center bg-gradient-to-br from-blue-700 via-indigo-700 to-purple-700 shadow-xl w-14 h-14 rounded-full border-4 border-blue-200 ring-4 ring-blue-400/30">
      {icon}
    </div>
    <div className={`backdrop-blur-md bg-white/10 border border-blue-100/10 rounded-2xl shadow-2xl w-full md:w-5/12 px-8 py-6 mt-6 md:mt-0 ${side === 'left' ? 'md:text-right' : 'md:text-left'}`}>
...
const EducationTimeline = () => (
  <section className="relative max-w-4xl mx-auto px-4 py-20 bg-gradient-to-br from-[#232946] via-[#2d3250] to-[#232946] rounded-3xl shadow-2xl mt-16 mb-20 overflow-hidden">
    ...
    {/* Section Heading */}
    <h2 className="relative z-10 text-center text-4xl font-extrabold text-white mb-16 tracking-tight">
