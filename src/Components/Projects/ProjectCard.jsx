    ...
    >
      ...
      <div className="p-5 md:p-6 flex flex-col flex-grow">
        <div className="flex-grow">
          <motion.h3 
            className="text-xl font-semibold text-white mb-2.5"
          ...
          <motion.p 
            className="text-gray-300 text-sm md:text-base leading-relaxed mb-4 line-clamp-3"
          ...
          <div className="flex flex-wrap gap-2">
            {tags.map((tag, index) => (
              <motion.span
                key={index}
                className="px-3 py-1 text-xs md:text-sm bg-[#465697]/30 rounded-full text-[#A3BFFA] cursor-default"
      ...
      <div className="absolute inset-0 rounded-xl pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <div className="absolute -inset-1 bg-gradient-to-r from-[#465697]/10 to-teal-500/10 rounded-xl blur-sm"></div>
      </div>
    </motion.div>
  );
});
